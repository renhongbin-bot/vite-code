(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))l(t);new MutationObserver(t=>{for(const e of t)if(e.type==="childList")for(const c of e.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&l(c)}).observe(document,{childList:!0,subtree:!0});function d(t){const e={};return t.integrity&&(e.integrity=t.integrity),t.referrerpolicy&&(e.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?e.credentials="include":t.crossorigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function l(t){if(t.ep)return;t.ep=!0;const e=d(t);fetch(t.href,e)}})();const o="/88e1fc84.2.webp";console.log(o);const r=document.createElement("img");r.src=o;document.body.appendChild(r);const a=`<?xml version="1.0" encoding="utf-8"?>
...
`;console.log(a);document.body.innerHTML=a;const i=document.getElementsByTagName("svg")[0];i.getElementsByTagName("style")[0];i.onmouseenter=function(){this.style.fill="red"};const g="alice",f="18";console.log(g,f);fetch("/api/users",{method:"post"}).then(n=>{console.log(n)}).catch(n=>{console.log(n)});
